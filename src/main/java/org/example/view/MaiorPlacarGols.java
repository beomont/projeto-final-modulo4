...
import org.example.controller.PartidaGols;
...
public class MaiorPlacarGols {
    ...
    public static void imprimirMaiorPlacar() throws  IOException{
        ...
        System.out.print("☑ ");
        System.out.println("O Placar da partida com mais gols foi (Time Mandante | Placar Mandante X Time Visitante | Placar Visitante ):");
